...
class ChainEngine:
    ...
    def __init__(self, app=None):
        ...
        self.chains_file = app.config['CHAINS_FILE'] if app else "data/chains.json"
        self.chains = {}
        self.plugins = {}
        self.remote_responses = {}
        self.response_queues = {}

        # Utworzenie katalogu dla pliku chains.json, jeśli nie istnieje
    ...
    def set_mqtt_client(self, mqtt_client):
        """
        Ustawia klienta MQTT dla silnika chainów.
    ...
    def _save_chains(self):
        ...
        try:
            ...
            with open(self.chains_file, "w", encoding="utf-8") as f:
                json.dump(self.chains, f, indent=4, ensure_ascii=False)
    ...
    def _run_local_plugin(self, plugin_name, data, config):
        ...
        try:
            ...
            # Zaktualizowana ścieżka importu zgodnie z nową strukturą katalogów
            module_path = f"morris.core.plugins.{module_name}"
    ...
    def _get_plugin_instance(self, plugin_name):
        ...
        try:
            # Dynamiczne importowanie modułu wtyczki - zaktualizowana ścieżka
            module_name = f"morris.core.plugins.{plugin_name.lower()}"
